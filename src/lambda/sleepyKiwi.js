...
const sayGoodnight_Handler =  {
    ...
    handle(handlerInput) {
        ...
        if (slotValues.kiwi.heardAs && slotValues.kiwi.heardAs !== '') {
            // slotStatus += ' slot kiwi was heard as ' + slotValues.kiwi.heardAs + '. ';
            slotStatus += slotValues.kiwi.heardAs;
        } else {
            // slotStatus += 'slot kiwi is empty. ';
            slotStatus += ' sleepy kiwi';
        }
        // if (slotValues.kiwi.ERstatus === 'ER_SUCCESS_MATCH') {
        //     slotStatus += 'a valid ';
        //     if(slotValues.kiwi.resolved !== slotValues.kiwi.heardAs) {
        //         slotStatus += 'synonym for ' + slotValues.kiwi.resolved + '. '; 
        //         } else {
        //         slotStatus += 'match. '
        //     } // else {
        //         //
        // }
        // if (slotValues.kiwi.ERstatus === 'ER_SUCCESS_NO_MATCH') {
        //     slotStatus += 'which did not match any slot value. ';
        //     console.log('***** consider adding "' + slotValues.kiwi.heardAs + '" to the custom slot type used by slot kiwi! '); 
        // }

        // if( (slotValues.kiwi.ERstatus === 'ER_SUCCESS_NO_MATCH') ||  (!slotValues.kiwi.heardAs) ) {
        //   // slotStatus += 'A few valid values are, ' + sayArray(getExampleSlotValues('sayGoodnight','kiwi'), 'or');
        // }
